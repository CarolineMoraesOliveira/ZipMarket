...
<body style="background-color: black; font-family: fantasy;">
    ...
    <form:form action="/donation/${id}" modelAttribute="thingToBeDonate" method="POST">
        ...
        <div class="text-end">
            <form:input type= "hidden" path = "personWhoIsGoingToDonate" value="${loggedUser.id}"></form:input>
